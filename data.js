...
//    2. Set  logo: "images/your-logo.png"  below
//    3. To use the default letter mark instead, set  logo: ""
//
//  SPEAKER PHOTOS
//    1. Place speaker images in the  images/speakers/  folder
//    2. Update the  photo:  field for each speaker below
//       e.g.  photo: "images/speakers/amina-osei.jpg"
//    3. If no photo is provided, initials are shown automatically
//
//  REGISTRATION LINK
//    Update  registrationUrl  below — it applies to BOTH the nav
//    "Register" button and the hero "Register Now" button.
//
// ─────────────────────────────────────────────────────────────────────────────
...
const APP_DATA = {
  ...
  // ── SPEAKERS ───────────────────────────────────────────────────────────────
  // photo: set to a file path  e.g. "images/speakers/amina-osei.jpg"
  //        leave as ""  to auto-generate initials avatar
  speakers: [
    {
      id: "spk1",
      name: "Dr. Amina Osei",
      ...
      org: "Esri",
      photo: "",
      bio: "Dr. Amina Osei leads Esri's operations across East Africa, overseeing technology deployment for government, utilities, and NGO clients in 12 countries. She holds a PhD in Geoinformatics from ITC Netherlands and has 18 years of GIS experience.",
    ...
    },
    {
      ...
      photo: "",
      bio: "Emeka specialises in ArcGIS Pro, ArcGIS Online, and enterprise GIS deployments. He has trained over 300 professionals across Nigeria and Ghana in the past 3 years.",
      linkedin: "https://linkedin.com",
    ...
    },
    {
      ...
      org: "Sambus Geospatial",
      photo: "",
      bio: "Fatima designs and deploys ArcGIS Enterprise environments for large organisations, including federal agencies and multinational energy companies.",
      linkedin: "https://linkedin.com",
    ...
    },
    {
      ...
      photo: "",
      bio: "Dr. Boateng's research focuses on land cover change, agricultural remote sensing, and climate impact analysis using hyperspectral imagery.",
      linkedin: "https://linkedin.com",
    ...
    },
    {
      ...
      org: "Sambus Geospatial",
      photo: "",
      bio: "James manages Trimble hardware sales and technical support for East and West Africa. He has led survey equipment deployments for major infrastructure projects.",
      linkedin: "https://linkedin.com",
      sessions: ["s05", "s11"]
    },
    {
      ...
      photo: "",
      bio: "Sophie is Wingtra's Africa applications lead, supporting WingtraOne deployments across mining, agriculture, and infrastructure sectors.",
      linkedin: "https://linkedin.com",
  ...
  products: [
    {
      ...
      description: "ArcGIS Pro is Esri's flagship desktop application — a 64-bit professional tool for spatial analysis, map production, 3D modelling, and advanced geoprocessing.",
    ...
    },
    {
      ...
      description: "ArcGIS Enterprise lets organizations host, manage, and share geospatial data, maps, and apps on their own infrastructure or cloud.",
    ...
    },
    {
      ...
      description: "ENVI is the world's most-used remote sensing platform for hyperspectral and multispectral image analysis.",
    ...
    },
    {
      ...
      description: "The WingtraOne combines the coverage of a fixed-wing aircraft with the vertical takeoff of a multirotor — no runway needed.",
    ...
    },
    {
      ...
      description: "Trimble's GNSS receivers and total stations are the backbone of precise surveying across Sambus's client base in West and East Africa.",
